...
export const navItems: INavData[] = [
  ...
  { title: true, name: 'Nhân viên' },
  { name: 'Nhân viên', url: '/personnel', icon: 'icon-people' },

  { title: true, name: 'Ứng viên' },
  { name: 'Ứng tuyển', url: '/candidate', icon: 'icon-envelope-letter' },
  
  { title: true, name: 'Hiển thị trang chủ' },
  { name: 'Banner', url: '/banner', icon: 'icon-screen-desktop' },
  { name: 'Bài viết', url: '/articles', icon: 'icon-note' },
  { name: 'Bài tuyển dụng', url: '/post_recruitment', icon: 'icon-note' },

  { title: true, name: 'Thành phần công ty' },
  { name: 'Phòng ban', url: '/department', icon: 'icon-briefcase' },
  { name: 'Chức danh', url: '/job_title', icon: 'icon-briefcase' },
  { name: 'Chức vụ', url: '/job_position', icon: 'icon-briefcase' },
  { name: 'Ngành nghề', url: '/career', icon: 'icon-briefcase' },
  { name: 'Tỉnh/Thành phố', url: '/city', icon: 'icon-map' },
  ...
  { name: 'Download CoreUI', url: 'http://coreui.io/angular/', icon: 'icon-cloud-download', class: 'mt-auto', variant: 'success', attributes: { target: '_blank', rel: 'noopener' } },
  { name: 'Try CoreUI PRO', url: 'http://coreui.io/pro/angular/', icon: 'icon-layers', variant: 'danger', attributes: { target: '_blank', rel: 'noopener' } }
];
